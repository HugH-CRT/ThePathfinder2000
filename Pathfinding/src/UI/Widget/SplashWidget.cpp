...
SplashWidget::SplashWidget(const sf::Vector2f& size, GameDataRef& gameDataRef) : UIWidget(size, gameDataRef)
{
...
SplashWidget::SplashWidget(UIElement& parent, const sf::Vector2f& size, std::string& name) : UIWidget(parent, size, name)
{
}
